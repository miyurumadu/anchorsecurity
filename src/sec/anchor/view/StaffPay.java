 ...
 */
public class StaffPay extends javax.swing.JPanel {
    ...
    public StaffPay() {
        try {
            ...
            Logger.getLogger(StaffPay.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(epfempcompText, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(etfempText, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(epfempconText, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addComponent(jLabel23)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(epfEmpAmountText))
                            .addGroup(jPanel3Layout.createSequentialGroup()
    ...
    private void finalizeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_finalizeButtonActionPerformed
        ...
        if (searchSalaryCons.isDeduction() && yesCheckBox.isSelected()) {
            totaldedction = (Double.parseDouble(advanceText.getText()) + Double.parseDouble(fineText.getText()) + fullBasic * searchSalaryCons.getEpf_empl() / 100);
            netSalaryForMonth = totalSalary - (Double.parseDouble(advanceText.getText()) + Double.parseDouble(fineText.getText()) + fullBasic * searchSalaryCons.getEpf_empl() / 100);
        } else {
            totaldedction = (Double.parseDouble(advanceText.getText()) + Double.parseDouble(fineText.getText()));
            netSalaryForMonth = totalSalary - (Double.parseDouble(advanceText.getText()) + Double.parseDouble(fineText.getText()));
        }
    ...
    private void payButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_payButtonActionPerformed
        String[] nic = (nicCombo.getSelectedItem() + "").split("-");
        Salary salary = new Salary(nic[nic.length - 1], datefrom, dateto, 0, Double.parseDouble(otText.getText()), Double.parseDouble(otherAlText.getText()),
                totalSalary, Double.parseDouble(advanceText.getText()), 0, Double.parseDouble(fineText.getText()), yesCheckBox.isSelected() ? Double.parseDouble(epfEmpAmountText.getText()) : 0.00,
    ...
    private void paymentTextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_paymentTextActionPerformed
        ...
        if (isPayed) {
            ...
            totalEarning = Double.parseDouble(paymentText.getText());
            ...
            if (totalEarning > fullBasic) {
                ...
                if (allowances > (searchSalaryCons.getOtlimit() * 75)) {
                    System.out.println((searchSalaryCons.getOtlimit() * 75));
